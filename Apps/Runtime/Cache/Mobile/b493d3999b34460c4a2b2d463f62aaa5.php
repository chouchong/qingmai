...
<div ng-app="myApp" ng-controller="drvCtrl">
    ...
    <!-- content -->
    <ion-content id="content-index" class="scroll-content has-header" style="background: #f5f5f5;padding:8px;" delegate-handle="drivesScroll">
        <!-- {__TOKEN__} -->
        ...
        <div class="row" style="background: #f5f5f5; padding: 0; margin-bottom: 8px;">
            <div style="margin: -8px;">
                <img src="/<?php echo ($drive["drivesImg"]); ?>" alt="" width="100%" id="drivesImg">
                <div class="" style="float:left; padding:8px; line-height: 180%;width: 100%;">
                    <p id="drivesName"><?php echo ($drive["drivesName"]); ?></p>
                    <p>
                        <span id="drivesFrom"><?php echo ($drive["drivesFrom"]); ?></span>
                        <span style="background:#FFD679;color:#fff;float:right;    padding: 0 20px;"><?php echo ($drive['drivesDay']-1); ?>晚<span id="drivesDay"><?php echo ($drive['drivesDay']); ?></span>夜跨境自驾自由行</span>
                    </p>
                    <p style="clear:both;">
        ...
        <div class="card" id="" style="margin: 0;">
            ...
            <div class="row" style="text-align: center;">
                <div class="item item-text-wrap">
                    <p>本起价是按2位成人参加<?php echo ($daytime); ?>出发的产品，并入住同一间房间的单人价格。</p>
                </div>
            </div>
        </div>
        ...
        <?php if($drive['drivesVisa'] == 1): ?><div class="row">
        ...
        <?php if($drive['drivesVisa'] == 1): ?><div class="row" style="padding: 0;margin: 20px 0 30px 0;">
    ...
    margin: 0 20px;color: #000;">所需资料</span>护照及签证：有效期内护照及泰国老挝两国签证</p>
        ...
        <?php if(is_array($drive['noWay'])): $i = 0; $__LIST__ = $drive['noWay'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$ht): $mod = ($i % 2 );++$i;?><ion-list class="hotelshow"  style="margin: -8px;" >
            <div class="hotelshows" >
                ...
                <p ><?php $__FOR_START_25536__=0;$__FOR_END_25536__=$ht['hotelStar'];for($i=$__FOR_START_25536__;$i < $__FOR_END_25536__;$i+=1){ ?><i class="iocn ion-star"></i><?php } ?>
        ...
        <div class="list card" style="margin:12px 0;">
            <div class="item">
                <h1>自驾游出游提示</h1>
            </div>
        ...
        <div class="list card cardPS usercomment">
            ...
            <?php if(is_array($drive['ap'])): $i = 0; $__LIST__ = $drive['ap'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$ap): $mod = ($i % 2 );++$i;?><div class="item item-body">
                    <p class="commentmsg">
                        ...
                        <?php $__FOR_START_28202__=0;$__FOR_END_28202__=$ap['drivesScore'];for($i=$__FOR_START_28202__;$i < $__FOR_END_28202__;$i+=1){ ?><i class="iocn ion-star"></i><?php } ?></span>
                    </p>
                    <p class="commenttime">
                ...
                <div class="card">
                    ...
                    <span ng-show="mygoForm.goTime.$dirty && mygoForm.goTime.$invalid">
                     <i class="icon ion-android-alert placeholder-icon loginrei" style="display: none;"></i>
                        ...
                        <input type="text" placeholder="请输入如<?php echo ($daytime); ?>格式的时间" ng-model="goTime.goTime" required name="goTime" ng-pattern="/^([0-9]{3}[1-9]|[0-9]{2}[1-9][0-9]{1}|[0-9]{1}[1-9][0-9]{2}|[1-9][0-9]{3})-(((0[13578]|1[02])-(0[1-9]|[12][0-9]|3[01]))|((0[469]|11)-(0[1-9]|[12][0-9]|30))|(02-(0[1-9]|[1][0-9]|2[0-8])))$/"></input>
                    </div>
                    <div class="item item-input">
