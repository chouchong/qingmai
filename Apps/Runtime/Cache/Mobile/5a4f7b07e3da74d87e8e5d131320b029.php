...
<input type="hidden" id="orderId" value="<?php echo ($orderId); ?>" />
    ...
    <div class="card">
        <ion-checkbox id="bigRoom" ng-model="isReadMe.checked" ng-checked="isReadMe.checked">本人及订单包含人员已阅读并同意<a href="#" style="color: blue;">《产品订购协议》</a></ion-checkbox>
    </div>
    ...
    <div class="row" style="background:#fff ;    font-size: 20px; ">
        ...
        <div class="col col-33" style="background:#F77462; text-align: center;">
            <a ng-click="odcf()" style="display: block;    text-decoration: none;">
