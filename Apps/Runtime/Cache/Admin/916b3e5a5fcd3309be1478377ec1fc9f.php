        ...
        <script>
	      ...
	      // function getTask(){
	    	 //  $.post("<?php echo U('Admin/Index/getTask');?>",{},function(data,textStatus){
	  			 ...
	  			 //    if(json.status==1){
	  			 //    	if(json.goodsNum>0){
	  			 //    		$('#attractionsTips').html(json.goodsNum).show();
	  			 //    	}else{
	  			 //    		$('#attractionsTips').hide();
	  			 //    	}
	  			 //    	if(json.shopsNum>0){
	  			 //    		$('#hotelsTips').html(json.shopsNum).show();
	  			 //    	}else{
	  			 //    		$('#hotelsTips').hide();
	  			 //    	}
                ...
                <section class="sidebar">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="treeview">
                            <a href="#">
                                <span>门票管理</span>
                                <small id='attractionsTips' style='display:none' class="badge pull-right bg-green">0</small>
                            </a>
                            <ul class="treeview-menu">
                                <?php if(in_array('spfl_00',$WST_STAFF['grant'])){ ?>
                                <li><a href="<?php echo U('Admin/GoodsCats/index');?>" target='pageContent'>门票分类</a></li>
                                <?php } ?>
                                <?php if(in_array('splb_00',$WST_STAFF['grant'])){ ?>
					            <li><a href="<?php echo U('Admin/Goods/index');?>" target='pageContent'>门票列表</a></li>
					            <?php } ?>
                                <?php if(in_array('spsh_00',$WST_STAFF['grant'])){ ?>
					            <?php } ?>
                                <?php if(in_array('sppl_00',$WST_STAFF['grant'])){ ?>
					            <!-- <li><a href="<?php echo U('Admin/GoodsAppraises/index');?>" target='pageContent'>门票评价</a></li> -->
					            <?php } ?>
                            </ul>
                        </li>
                        <?php } ?>
                        ...
                        <li class="treeview">
                            <a href="#">
                                <span>自驾管理</span>
                                <small id='hotelsTips' style='display:none' class="badge pull-right bg-green">3</small>
                            </a>
                            <ul class="treeview-menu">
                                <?php if(in_array('dplb_01',$WST_STAFF['grant'])){ ?>
                                <li><a href="<?php echo U('Admin/Drives/toEdit');?>" target='pageContent' >添加自驾</a></li>
                                <?php } ?>
                                <?php if(in_array('dplb_00',$WST_STAFF['grant'])){ ?>
                                <li><a href="<?php echo U('Admin/Drives/index');?>" target='pageContent' >自驾列表</a></li>
                                <?php } ?>
                                <?php if(in_array('dppl_00',$WST_STAFF['grant'])){ ?>
                                <li><a href="<?php echo U('Admin/DrivesAppraises/index');?>" target='pageContent' >自驾评论</a></li>
                                <?php } ?>
                            </ul>
                        </li>
                        <?php } ?>
                         <?php if(in_array('dpjd_00',$WST_STAFF['grant'])){ ?>
                        <li class="treeview">
                            <a href="#">
                                <span>酒店管理</span>
                                <small id='hotelsTips' style='display:none' class="badge pull-right bg-green">3</small>
                            ...
                            <ul class="treeview-menu">
                                <?php if(in_array('dpjd_02',$WST_STAFF['grant'])){ ?>
                                <li><a href="<?php echo U('Admin/Hotels/toView');?>" target='pageContent' >添加酒店</a></li>
                                <?php } ?>
                                <?php if(in_array('dpjd_01',$WST_STAFF['grant'])){ ?>
                                <li><a href="<?php echo U('Admin/Hotels/index');?>" target='pageContent' >酒店列表</a></li>
                                <?php } ?>
                            </ul>
                        </li>
                        <?php } ?>
                        ...
                        <li class="treeview">
                            ...
                            <ul class="treeview-menu">
                                ...
                                <li><a href="<?php echo U('Admin/Orders/queryRefundByPage');?>" target='pageContent'>出行列表</a></li>
                                <?php } ?>
                            </ul>
                        </li>
                        <?php } ?>
                        ...
                        <li class="treeview">
                            ...
                            <ul class="treeview-menu">
					            ...
					            <li><a href="<?php echo U('Admin/Coupons/index');?>" target='pageContent'>优惠码管理</a></li>
					            <?php } ?>
                                <?php if(in_array('bmdd_00',$WST_STAFF['grant'])){ ?>
                                <li><a href="<?php echo U('Admin/Place/index');?>" target='pageContent'>报名地点</a></li>
                                <?php } ?>
                        ...
                        <li class="treeview">
                            ...
                            <ul class="treeview-menu">
                                <li><a href="<?php echo U('Admin/Weixin/toSet');?>" target='pageContent' >微信设置</a></li>
                                <li><a href="<?php echo U('Admin/Weixin/menuList');?>" target='pageContent' >菜单设置</a></li>
                            </ul>
                        </li>
                        <?php } ?>
                    </ul>
