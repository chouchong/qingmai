               ...
               <?php if(is_array($vo)): foreach($vo as $key=>$v): ?><tr>
                  ...
                  <td>
                     ...
                     <?php }else if($v['fieldType']=='upload'){ ?>
                       	<form id="uploadform_<?php echo ($v['fieldCode']); ?>p" autocomplete="off" enctype="multipart/form-data" method="POST" target="upload" action="<?php echo U('Home/Base/uploadPic');?>" >
