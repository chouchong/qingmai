       ...
       <form name="myform" method="post" id="myform" autocomplete="off">
        ...
        <table class="table table-hover table-striped table-bordered wst-form">
           ...
           <tr>
             ...
             <table width='100%'>
                <tr>
                   <td rowspan='3' valign='top' width='100'><label><input type='checkbox' class='chk' onclick='javascript:checkModel(this)' value='spgl'/>景点管理</label></td>
               ...
               <!--  <tr>
                   <td><label><input type='checkbox' class='chk spgl sppl' value='sppl' onclick='javascript:checkModel(this)'/>门票评论</label></td>
                   <td>
