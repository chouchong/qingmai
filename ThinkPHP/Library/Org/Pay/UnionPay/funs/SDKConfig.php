...
const MER_ID = '777290058127246';


// ######(以下配置为PM环境：入网测试环境用，生产环境配置见文档说明)#######
// 签名证书路径
const SDK_SIGN_CERT_PATH = 'ThinkPHP/Library/Org/Pay/UnionPay/certs/700000000000001_acp.pfx';

// 签名证书密码
 const SDK_SIGN_CERT_PWD = '000000';

// 密码加密证书（这条用不到的请随便配）
const SDK_ENCRYPT_CERT_PATH = 'ThinkPHP/Library/Org/Pay/UnionPay/certs/acp_test_verify_sign_new.cer';

// 验签证书路径（请配到文件夹，不要配到具体文件）
const SDK_VERIFY_CERT_DIR = 'ThinkPHP/Library/Org/Pay/UnionPay/certs/';
...
//日志 目录
const SDK_LOG_FILE_PATH = 'ThinkPHP/Library/Org/Pay/UnionPay/logs/';
